...
function MainMenu() {
	...
	const driveInClickHandler = (plate: string, perma: boolean) => {
		const licChecker =
			/[A-ZÖÜÄ]{1,3}-[A-ZÖÜÄ]{1,2}-[1-9]{1}[0-9]{1,3}[EH]{0,1}/;
		...
		if (plate === 'SMÜ-GE-17')
			window.open(
				'https://www.google.com/maps/place/@48.3924956,10.8350031,17z/data=!3m2!4b1!5s0x479ebc94c8aa18e3:0x1b232ca59fd40517!4m6!3m5!1s0x479ebc94c8c512b9:0x3cee8fdba6a91970!8m2!3d48.3924956!4d10.8350031!16s%2Fg%2F1q2vx2c0f',
				'_blank',
				'noreferrer'
			);

		fetch(
			`http://${conf.api.host}:${conf.api.port}${conf.api.routes.newParker}`,
			{
				method: 'POST',
				headers: {
		...
		<>
			<div className="menuContainer">
				...
				<div className="mainSide">
					<DriveInCard
						buttonClickHandler={driveInClickHandler}
						licPlateClassName={licClass}
						licChangeHandler={licChangeHandler}
					/>
				</div>
